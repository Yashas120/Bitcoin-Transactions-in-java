...
public class HashTest{
    ...
    public void test_short_sha256(){
        Sha hash = new Sha();
        String actual = hash.sha256("OOAD-short-test");
    ...
    public void test_medium_sha256(){
        Sha hash = new Sha();
        String actual = hash.sha256("An aim is a goal or objective to achieve in life. " + 
                                    ...
                                    "I want to be a lovable and respectable person as a teacher in the future."
                                );
    ...
    public void test_hard_sha256(){
        Sha hash = new Sha();
        String actual = hash.sha256("An00aim||||life75756htg977v899 85757is 8578a 986988goal or objective to ach||||life75756htgieve in life. " + 
                                    ...
                                    "I want to be||||life75756htg a lov||||life75756htgable and re||||life75756htgspectable person as a teacher in the future."
                                );
